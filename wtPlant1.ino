...
String apiKey = "4UCS0JOW8CA1MFVH";     //  Enter your Write API key here
const char* server = "api.thingspeak.com";
const char *ssid =  "SD Lab";     // Enter your WiFi Name
const char *pass =  "Sdklab22"; // Enter your WiFi Password
